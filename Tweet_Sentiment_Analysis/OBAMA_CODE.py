...
#print obama_test
for index,row  in obama_sheet.iterrows():
	class_row = row['Class']
...
for index1,row1  in obama_test.iterrows():
...
classifier = Pipeline([('vectorizer', CountVectorizer()),('tfidf', TfidfTransformer()),('clf', MultinomialNB())])
